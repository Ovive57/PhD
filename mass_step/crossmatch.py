...
def positional_crossmatch(cat_file1, cat_file2, dim, max_sep, max_sep3d=None, cosmology = Planck18,frame = 'icrs', verbose = True):
    ...
    if dim == 2:
        ...
        output_path = f"crossmatches/positional/crossmatch_GAMA_ZTF_maxsep_{max_sep}arcsec_dim{dim}.fits"
    ...
    if dim ==3:
        ...
        output_path = f"crossmatches/junk/crossmatch_GAMA_ZTF_maxsep_{max_sep}arcsec_dim{dim}_onsky.fits"
...
def separations(cat_file1, cat_file2, max_sep, frame = 'icrs', test = False):
    ...
    result_table_final.write('crossmatches/dlr/nearby_galaxies_all_supernovae_with.fits', overwrite=True)
